...
==============================================================================*/
package com.example.hearme.detection
...
class MultiBoxTracker(context: Context) {
    ...
    private fun processResults(results: List<Recognition>) {
        ...
        for (result in results) {
            ...
            screenRects.add(Pair(result.getConfidence(), detectionScreenRect))
            if (detectionFrameRect.width() < MIN_SIZE || detectionFrameRect.height() < MIN_SIZE) {
                continue
            }
            rectsToTrack.add(Pair<Float, Recognition>(result.getConfidence(), result))
        }
